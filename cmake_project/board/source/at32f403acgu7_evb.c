...
gpio_type *led_gpio_port[LED_NUM]        = {LED_GPIO};
uint16_t led_gpio_pin[LED_NUM]           = {LED_PIN};
crm_periph_clock_type led_gpio_crm_clk[LED_NUM] = {LED_GPIO_CRM_CLK};
